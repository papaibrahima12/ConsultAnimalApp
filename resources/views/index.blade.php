...
<head>
  ...
  <title>Sen Ferme SN &amp;</title>

  <!-- bootstrap.min css -->
  <link rel="stylesheet" href="{{ asset('accueil/plugins/bootstrap/css/bootstrap.min.css') }}">
  <!-- Animate Css -->
  <link rel="stylesheet" href="{{ asset('accueil/plugins/animate-css/animate.css') }}">
  <!-- Icon Font css -->
  <link rel="stylesheet" href="{{ asset('accueil/plugins/fontawesome/css/all.css') }}">
  <link rel="stylesheet" href="{{ asset('accueil/plugins/fonts/Pe-icon-7-stroke.css') }}">
  <!-- Themify icon Css -->
  <link rel="stylesheet" href="{{ asset('accueil/plugins/themify/css/themify-icons.css') }}">
  <!-- Slick Carousel CSS -->
  <link rel="stylesheet" href="{{ asset('accueil/plugins/slick-carousel/slick/slick.css') }}">
  <link rel="stylesheet" href="{{ asset('accueil/plugins/slick-carousel/slick/slick-theme.css') }}">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6">
                    <div class="top-bar-left text-white">
                        ...
                        <span class="ml-2">Keur Massar CITE Almadies 2 villa n145</span>
                    </div>
                </div>
                ...
                <div class="col-lg-8 justify-content-end ml-lg-auto d-flex col-12 col-md-12 justify-content-md-center">
                    <div class="top-info-block d-inline-flex">
                        ...
                        <div class="info-block">
                            <h5 class="font-weight-500">777840964</h5>
                            <p>Appelez nous</p>
                        </div>
                    </div>
                    ...
                    <div class="top-info-block d-inline-flex">
                        ...
                        <div class="info-block">
                            <h5 class="font-weight-500">sowibou032@gmail.com</h5>
                            <p>Email Us</p>
                        </div>
                    </div>
                    <div class="top-info-block d-inline-flex">
                ...
                <div class="col-md-12 col-lg-7 text-center text-lg-left">
                    <div class="main-banner">
                        ...
                        <h1 class="display-4 mb-4 font-weight-normal">
                            Notre élevage, notre priorite
                        </h1>

                        <!-- Subheading -->
                        <p class="lead mb-4">
                           Sen Ferme SN est une ferme d'elevage de differents animaux comme les moutons,chevres,boeufs,chevaux,...
                        </p>
            ...
            <div class="row justy-content-center">
                <div class="col-lg-3 col-sm-6 col-md-6">
                    <div class="text-center feature-block">
                        ...
                        <h4 class="mb-2">Les bons conseils</h4>
                        <p>Notre equipe vous accompagne dans la realisation de vos projets.</p>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 text-center">
                    <div class="section-heading">
                        ...
                        <!-- Subheading -->
                        <p>
                            Sen Ferme SN can be used to create anything from a small marketing page to a sophisticated website.
                        </p>
...
<section class="section" id="section-testimonial">
 ...
 <footer class="section " id="footer">
    ...
    <!-- Main jQuery -->
    <script src="{{ asset('accueil/plugins/jquery/jquery.min.js') }}"></script>
    <!-- Bootstrap 3.1 -->
    <script src="{{ asset('accueil/plugins/bootstrap/js/popper.min.js') }}"></script>
    <script src="{{ asset('accueil/plugins/bootstrap/js/bootstrap.min.js') }}"></script>
    <!-- Slick Slider -->
    <script src="{{ asset('accueil/plugins/slick-carousel/slick/slick.min.js') }}"></script>
    <script src="{{ asset('accueil/js/jquery.easing.1.3.js') }}"></script>
    <!-- Map Js -->
    <script src="{{ asset('accueil/plugins/google-map/gmap3.min.js') }}"></script>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDwIQh7LGryQdDDi-A603lR8NqiF3R_ycA"></script>

    <script src="{{ asset('accueil/js/form/contact.js') }}"></script>
    <script src="{{ asset('accueil/js/theme.js') }}"></script>
