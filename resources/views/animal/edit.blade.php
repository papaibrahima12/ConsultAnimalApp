                ...
                @csrf
                    ...
                    <div class="row">
                        <div class="form-group col-xl-6">
                            ...
                            <input class="form-control" type="text" name="age" id="age" value="{{ $animal->age }}" />>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-xl-6">
                            ...
                            <input class="form-control" type="text" name="race" id="race" value="{{ $animal->race }}" />
                        </div>
                    </div>

                    <div class="form-group">
                        <input class="btn btn-success" type="submit" name="envoyer" id="envoyer" value="Changer" />
